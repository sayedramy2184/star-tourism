    ...
    <>
      ...
      {open && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(22,19,14,0.55)', zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(3px)', padding: '16px' }}
          ...
          <div style={{ background: '#fff', border: '1px solid #e4e6ea', width: '640px', maxWidth: '96vw', maxHeight: '92vh', overflowY: 'auto', boxShadow: '0 24px 60px rgba(0,0,0,0.2)' }}>
            ...
            <form onSubmit={save} style={{ padding: '18px 24px 24px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', paddingTop: '16px', marginTop: '8px', borderTop: '1px solid #e4e6ea' }}>
